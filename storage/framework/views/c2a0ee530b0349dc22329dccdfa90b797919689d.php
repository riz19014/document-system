  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Select Meta-Tags for folder "<?php echo e($foldered->description); ?>"</h5>
...
<?php $__currentLoopData = $metaTagNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  ...
  <ul style="list-style: none;"><li>
      ...
      <div class="form-check">
            <input style="height: 35px;width: 40px;" class="form-check-input batchCheckbox" name="column_folder[]" type="checkbox" value="<?php echo e($meta->id); ?>" id="flexCheckDefault" <?php echo e(($metaTags->contains('meta_tag_id',$meta->id)) ? 'checked' : ''); ?> />

          <label class="form-check-label" for="flexCheckDefault" style="font-size: 25px;padding-left: 0.4em;">
            <?php echo e($meta->tagging_name); ?>  
          </label>
      </div> 
    </li>
  </ul>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
            ...
            <input type="hidden" name="folder_id_col" id="col_folder_id" value="<?php echo e($foldered->id); ?>" />
          </div>
...
$(document).on('submit','#file_retention',function(e){   
   e.preventDefault(); 
    ...
    $.ajax({
         type: "POST",
         url: "<?php echo e(route('file-retention')); ?>",
         data: formData,
         contentType: false,
         processData: false,
    ...
    // $(this).removeClass('d-none');
       ...
       // $('.revert-quotations').removeClass('d-none');
        ...
        if(this.checked == true){
         ...
         //  url:"<?php echo e(route('proceed-invoice-order')); ?>",
...
$(document).ready(function () {
    // Multiple images preview with JavaScript
      ...
      $('#chooseFile').on('change', function() {
        var fol_id = "<?php echo e($foldered->id); ?>";
      // alert(fol_id);
...
// });
    ...
    if(folder.length<1){
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo e(route('add-folder')); ?>",
  ...
  $(document).on('submit','#column_Part',function(e){   
        ...
        $.ajax({
        type: "POST",
        url: "<?php echo e(route('add-column-folder')); ?>",
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Tariq_Naeem\TNN\Laravel\DMS_S\NDMS\resources\views/folder/index.blade.php ENDPATH**/ ?>